...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    HomeVC *mainController = [[HomeVC alloc] init];
    ...
    DDMenuController  * menu =[[DDMenuController alloc]initWithRootViewController:navController];
    _menuController = menu;
    menu.leftViewController=vc;
